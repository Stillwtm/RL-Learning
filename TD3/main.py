...
if __name__ == '__main__':
    ...
    parser.add_argument('--env_name', type=str, default='HalfCheetah-v4', help='environment name, refer to gym doc')
    parser.add_argument('--seed', nargs='+', type=int, default=None, help='random seed for all')
    parser.add_argument('--ep_max_steps', type=int, default=int(1e6), help='max steps in one episode')
    parser.add_argument('--max_train_steps', type=int, default=int(1e6), help='max training steps')
    parser.add_argument('--eval_every', type=int, default=int(5e3), help='evaluate interval, in steps')
    parser.add_argument('--save_model_every', type=int, default=int(5e5), help='save model interval, in steps')
    ...
    parser.add_argument('--start_size', type=int, default=int(25e3), help='initial buffer size to start training')
